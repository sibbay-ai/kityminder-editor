         ...
         */
            ...
            var ClickIDIcon = kity.createClass("ClickIDIcon", {
                ...
                constructor: function() {
                    ...
                    this.width = 24;
                    this.height = 22;
                    this.rect = new kity.Rect(24, 22, -2, -6, 4).fill("rgba(255, 255, 255, 0)");
                    this.path = new kity.Path().setPathData(Click_PATH).fill("#d4237a");
            ...
            var ClickIDIconRenderer = kity.createClass("ClickIDIconRenderer", {
                ...
                create: function(node) {
                    ...
                    icon.on("click", function() {
                        node.getMinder().fire("clickidrequest", {
                            node: node,
                            icon: icon
                        });
                    });
    ...
    value: function(require, exports, module) {
        ...
        Module.register("TypeIconsModule", function() {
            ...
            var TypeIconsIcon = kity.createClass("TypeIconsIcon", {
                ...
                create: function() {
                    var icons = {
                        healthbubble: new kity.Path().setPathData(HEALTHBUBBLE_PATH).fill("#f4ea2a").scale(.02),
                        mchoice: new kity.Path().setPathData(MCHOICE_PATH).fill("#f4ea2a").scale(.02),
